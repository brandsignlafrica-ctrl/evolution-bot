[12:27, 6/8/2026] Tyronne: 'use strict';
...
[12:32, 6/8/2026] Tyronne: 'use strict';
...
async function sendWhatsApp(number, text, imageUrl = null) {
  ...
  console.log([Bot] Dispatching payload to ${endpoint}. Image present: ${!!imageUrl});
...
app.post('/webhook', async (req, res) => {
  ...
  try {
    ...
    // Fixed typo here (changed genErr to err)
